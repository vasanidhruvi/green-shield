        ...
        <div className="md:col-span-2 space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-background/50">
                  <div>
                    <Label htmlFor="challenge-updates" className="cursor-pointer">Challenge Updates</Label>
                 ...
                 <div className="flex items-center justify-between p-4 rounded-lg bg-background/50">
                  <div>
                    <Label htmlFor="community-alerts" className="cursor-pointer">Community Alerts</Label>
